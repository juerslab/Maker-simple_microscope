...
- https://amscope.com/products/a40x-yx-v460
    This objective requires the use of a spacer (see below)
...
3D printed with and FDM printer. Also requires a 3D printed adapter for attaching the objective. 
...
Spacer ring if this objective is used:
https://amscope.com/products/a40x-yx-v460
